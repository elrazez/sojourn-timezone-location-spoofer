...
4. **Restricted tabs are never Covered and must show as not Covered:** `chrome://`, all of `chrome.google.com` and `chromewebstore.google.com`, `file://` without file access, interstitials, and pages framing another extension.
